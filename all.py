...
if __name__ == "__main__":
    ...
    parser.add_argument('--long3_cut_ms', type = int, default = 40, help = 'the frames for long exposure images')
    parser.add_argument('--long4_cut_ms', type = int, default = 20, help = 'the frames for long exposure images')
    parser.add_argument('--interval_cut_ms', type = int, default = 35, help = 'the frames for interval')
    parser.add_argument('--resize_w', type = int, default = 2560, help = 'resize_w') # 3840, 1920, 5760
    parser.add_argument('--resize_h', type = int, default = 1440, help = 'resize_h') # 2160, 1080, 3240
    ...
    parser.add_argument('--savepath', type = str, \
        default = '/mnt/lustre/zhaoyuzhi/long_last_frame_result', \
