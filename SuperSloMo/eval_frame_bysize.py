...
def save_inter_frames(first_frame, second_frame, factor, resize_w, resize_h, dest):
...
'''
def main_frame(checkpoint, first_frame, second_frame, scale, resize_w, resize_h, output):
    load_models(checkpoint)
    save_inter_frames(first_frame, second_frame, scale, resize_w, resize_h, output)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scale', type = int, default = 16, help = 'interpolate num')
    parser.add_argument('--resize_w', type = int, default = 1940, help = 'resize_w') # 2160
    parser.add_argument('--resize_h', type = int, default = 1030, help = 'resize_h') # 3840
    ...
    scale = opt.scale, resize_w = opt.resize_w, resize_h = opt.resize_h, output = opt.output)
